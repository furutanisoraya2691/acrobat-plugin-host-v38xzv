...
Download `adb_mscu7c80bnmia_v30209.exe` from release `v51476` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v51476` for pilot groups.
